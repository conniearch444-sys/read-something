...
import { buildConversationKey, readConversationBucket, persistConversationBucket, detachMemoriesFromBook, condenseBookProfileOnDelete } from './utils/readerChatRuntime';
...
const App: React.FC = () => {
  ...
  const handleDeleteBook = async (bookId: string) => {
    ...
    condenseBookProfileOnDelete(bookId);
